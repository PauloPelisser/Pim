🛡️ Escola Digital Segura: Educação e Proteção na Era Tecnológica
Status Licença MIT
...
Inicialização do Back-End: app.py
...
Crie uma ramificação ( git checkout -b feature/sua-feature)
Comprometa suas mudanças ( git commit -m 'Adiciona nova funcionalidade')
Empurre para sua filial ( git push origin feature/sua-feature)
